...
/*1. Значение переменной 'stock' должно быть равно '100'
2. При значении invoice = 50 значение переменной 'message' должно быть равно 'Заказ оформлен, с вами свяжется менеджер'
3. При значении invoice = 100 значение переменной 'message' должно быть равно 'Заказ оформлен, с вами свяжется менеджер'
4. При значении invoice = 150 значение переменной 'message' должно быть равно 'На складе недостаточно товаров!'
5. Ожидается использование объявления 'const' для 'stock'*/
